...
class __TwigTemplate_cbd61185ec23efc189b8abfb74c3419a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\thref=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_plat", ["id" => twig_get_attribute($this->env, $this->source, $context["categorie"], "id", [], "any", false, false, false, 24)]), "html", null, true);
...
\t</div>
{% endblock %}
", "categorie/index.html.twig", "/home/test/Bureau/symfony_district/templates/categorie/index.html.twig");
    }
}
