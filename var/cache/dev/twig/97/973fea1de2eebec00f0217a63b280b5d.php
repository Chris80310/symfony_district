...
class __TwigTemplate_f61f90fd92f7fed801073a4ea6553004 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["plats"]) || array_key_exists("plats", $context) ? $context["plats"] : (function () { throw new RuntimeError('Variable "plats" does not exist.', 17, $this->source); })()));
...
\t\t\t\t\t\t\thref=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_detail_plat", ["id" => twig_get_attribute($this->env, $this->source, $context["plat"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\" style=\"text-decoration:none\">
\t\t\t\t\t\t\t<!-- affichage des noms de catégories -->
\t\t\t\t\t\t\t<h5 class=\"card-title text-center my-2\">
\t\t\t\t\t\t\t\t<strong>\"";
            // line 25
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, $context["plat"], "libelle", [], "any", false, false, false, 25)), "html", null, true);
            echo "\"</strong>
\t\t\t\t\t\t\t</h5>
\t\t\t\t\t\t\t<!-- partie inférieure avec l'image -->
\t\t\t\t\t\t\t<img src=\"";
            // line 28
            echo twig_escape_filter($this->env, ("/images_the_district/food/" . twig_get_attribute($this->env, $this->source, $context["plat"], "image", [], "any", false, false, false, 28)), "html", null, true);
...
";
    ...
    {
        return array (  137 => 37,  122 => 28,  116 => 25,  110 => 22,  104 => 18,  100 => 17,  96 => 15,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t</div>
{% endblock %}
", "plat/index.html.twig", "/home/test/Bureau/symfony_district/templates/plat/index.html.twig");
    }
}
