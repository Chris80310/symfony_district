...
\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 37
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("panier_remove", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "plat", [], "any", false, false, false, 37), "id", [], "any", false, false, false, 37)]), "html", null, true);
            echo "\" class=\"btn btn-warning\">-</a>
\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 38
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("panier_delete", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "plat", [], "any", false, false, false, 38), "id", [], "any", false, false, false, 38)]), "html", null, true);
...
\t\t\t\t\t\t\t\t\t&euro;</td>
\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t<a href=\"{{ path ('panier_add', {id: item.plat.id}) }}\" class=\"btn btn-success\">+</a>
\t\t\t\t\t\t\t\t\t<a href=\"{{ path ('panier_remove', {id: item.plat.id}) }}\" class=\"btn btn-warning\">-</a>
\t\t\t\t\t\t\t\t\t<a href=\"{{ path ('panier_delete', {id: item.plat.id}) }}\" class=\"btn btn-danger\">Supprimer</a>
\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t{% else %}
\t\t\t\t\t\t\t<tr>
