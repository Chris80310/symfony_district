...
class __TwigTemplate_69a064d48c8d36e45e00c1aa02b0ec2d extends Template
{
    private $source;
    private $macros = [];
...
{% for js_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_js_assets.html.twig", "/home/test/Bureau/symfony_district/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_js_assets.html.twig");
    }
}
